...
@Component
public class InsertBilltoMachine implements PTalkEventListener {
	...
	public static void openDoortoPushMoney() {
		System.out.println("Hello World123!");
		InsertBilltoMachine main = new InsertBilltoMachine();
	...
	public static void stopInsertion() {
		if (mAcceptor != null) {
	...
	public void configuration() {
		...
		RS232Configuration.INSTANCE
				.setEventMask(RS232Configuration.DEFAULT_EVENT_MASK & ~(Events.SerialData.getIntId()));
	}
	...
	public void changeEventReceived(PTalkEvent evt) {
		...
		if (evt.getId() == Events.SerialData) {
			...
			// System.out.println(String.format("Acceptor is no longer responding! Count:
			// %d", c.getFailureCount()));
